...
/* reads a census year from csv file and stores the data*/
void read_cyear(dict_t *line, FILE* fp){  
    int c=0, i=0;
    int check=0, found=0, count=0;
    
	int m_size=SIZE; int r_size=0;
...
/* reads a block id from csv file and stores the data*/
...
/* reads a property id from csv file and stores the data*/
...
/* reads a base area from csv file and stores the data*/
...
/* reads a clue area from csv file and stores the data*/
...
/* reads a trading name from csv file and stores the data*/
void read_trading_name(dict_t *line, FILE* fp){ 
    int c=0, i=0;
	
	//int r_size=0; int m_size=MAXKEYSIZE;
...
/* reads an industry code from csv file and stores the data*/
...
/* reads an industry_description from csv file and stores the data*/
...
/* reads x value from csv file and stores the data*/
...
/* reads y value from csv file and stores the data*/
...
/* reads location from csv file and stores the data*/
...
/* prints a line of dict_t data. can be used for debugging */
...
/* =====================================================================
   Program written by Hasne Hossain for his project work
   ================================================================== */